...
namespace Crm\CountSubscriptionModule\Forms;
...
class SubscriptionFormFactory
{
    ...
    public function create(int $subscriptionId = null, IRow $user = null)
    {
        ...
        $form->addTextArea('articles', 'countsubscriptions.data.subscriptions.fields.articles')
            ->setAttribute('placeholder', 'countsubscriptions.data.subscriptions.placeholder.articles')
            ->getControlPrototype()
            ->addAttributes(['class' => 'autosize']);
